...
class AssistantMessage(CommonColumns, Base):
    ...
    __table_args__ = (UniqueConstraint("thread_id", "ordinal", name="uq_messages_thread_ord"),)
    ...
    retrieval_jsonb: Mapped[dict] = mapped_column(JSONB, nullable=False, server_default="{}")
    attached_cards_jsonb: Mapped[list] = mapped_column(JSONB, nullable=False, server_default="[]")
