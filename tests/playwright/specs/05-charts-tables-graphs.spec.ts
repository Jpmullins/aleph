 ...
 * the real renderers for ChartCard / TableCard without needing a full upstream
 * dataset pipeline. (MapCard/GraphCard were deleted in WP-4e — no producer.)
 *
 ...
 * returns our crafted JSON. The renderer should produce a real Vega-Lite
 * canvas + sortable/filterable tables.
 */
