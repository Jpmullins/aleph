  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="inline-flex items-center gap-1.5 rounded-md border border-line bg-sunken px-2 py-0.5 font-semibold text-ink hover:border-[var(--accent,#f97316)]"
      >
        {activeSurface}
      </button>
      ...
      {openPageTitle && (
        <>
          ...
          <button
            ...
            className="max-w-[22rem] truncate rounded-md px-2 py-0.5 text-ink-soft hover:bg-sunken hover:text-ink"
          >
            {openPageTitle}
          </button>
        </>
      ...
      {selection?.text && (
        <span
          ...
          className="max-w-[16rem] truncate rounded-full bg-[var(--accent-muted,rgba(249,115,22,0.10))] px-2 py-0.5 text-[var(--accent,#f97316)]"
      ...
      {onUpload && (
        <button
          ...
          className="inline-flex items-center gap-1 rounded-md border border-line-strong px-2 py-0.5 font-medium text-ink-soft hover:border-accent hover:text-accent"
        >
