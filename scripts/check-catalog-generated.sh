...
#
# `tests/unit/test_catalog_agreement.py` catches a vocabulary the renderer or
# the action handlers cannot honour. This one catches something narrower and
# more fundamental: a generated file that no longer matches the source it was
# generated from.
#
